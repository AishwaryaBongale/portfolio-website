...
import profile_img from "@/public/Aish.jpeg";
...
const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Aishwarya.</span> I'm a{" "}
        <span className="font-bold">full-stack web developer</span> and{" "}
        <span className="font-bold">Onsite Coordinator</span> with{" "}
        <span className="font-bold">8 years</span> of experience. I thrive on{" "}
        <span className="italic">
          creating dynamic, user-friendly websites and ensuring smooth project
          execution.
        </span>
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="/Aishwarya-Bongale-Resume.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/aishwarya-bongale/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
